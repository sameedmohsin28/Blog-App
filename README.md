...
**Blog App** is, as the name explains, an app for personal blogging.
...
`git clone https://github.com/sameedmohsin28/Blog-App.git`
...
- **An API will be added in future for fetching data.**
...
Feel free to check the [issues page](https://github.com/sameedmohsin28/Blog-App/issues).
...
I would like to thank Microverse for teaching me Ruby on Rails.
...
This project is [MIT](https://github.com/sameedmohsin28/Blog-App/blob/Data-Model/LICENSE) licensed.
